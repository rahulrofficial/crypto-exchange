...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('last_purchased', models.DateTimeField(default=datetime.datetime(2023, 11, 22, 22, 50, 46, 73339))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('transaction_on', models.DateTimeField(default=datetime.datetime(2023, 11, 22, 22, 50, 46, 73339))),
                ('transacted_coin_value', models.FloatField()),
                ('transacted_amount', models.FloatField(default=0)),
                ('buyer_receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='received', to=settings.AUTH_USER_MODEL)),
