          ...
          document.querySelector("#exp_amount").innerHTML=''
					fetch("/info/wallet")
                        ...
                        fetch(
                            ...
                            req_amount=parseFloat(coin_data.data.priceUsd)*parseFloat(amount_val)
                            ...
                            document.querySelector("#exp_amount").innerHTML=`Required amount: $${req_amount.toFixed(4)}`
													});
                      },2000);
                      document
							...
							document
								...
								.addEventListener("click", () => {
									...
									if (data.wallet.all_coins.includes(list_coin.all_coins[coin_list.value])) {
										function repeat2() {
											crypto_coin_name=list_coin.all_coins[coin_list.value]
                          ...
                          exp_amount=parseFloat(coin_data.data.priceUsd)*parseFloat(amount_val)
                          exp_amount=exp_amount.toFixed(4)
                          if (amount_val>data.wallet.wallet[list_coin.all_coins[coin_list.value]]){
                          ...
                          document.querySelector("#exp_amount").innerHTML=`Expected amount: $${exp_amount}`
												});
										}
